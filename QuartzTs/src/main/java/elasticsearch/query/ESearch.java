...
//		System.out.println(HttpClientUtils.httpGet("http://10.10.10.179:9200/crm_allot/MemberInfo/_search"));
		service.delDocument("crm_allot", "MemberInfo", "AVVY932HuKL_exMHVwHQ");
	}
